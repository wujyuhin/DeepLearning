...
# =================================================================================================================
# =============================== 以下两种生成dataloader方式任选其一，并将其余部分注释掉 ==============================
# =================================================================================================================
# ================================  1.在train_loader中使用word2vec =================================================
# 划分数据集
...
X_train.reset_index(drop=True, inplace=True)
y_train.reset_index(drop=True, inplace=True)
train_data = HotelDataset(np.array(X_train), np.array(y_train))
train_loader = torch.utils.data.DataLoader(train_data, batch_size=64, shuffle=True, drop_last=True, collate_fn=None)


# ==================================================================================================================
# ================================= 以下两种训练方式任选其一，并将其余部分注释掉 ===========================================
# ==================================================================================================================
#  ===================================  1.训练模型(简单板块)  ========================================================
# 定义模型
